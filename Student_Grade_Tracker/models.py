...
# Parent class: holds the subject name, task title, max_score, due_date and assignment_type.
class Assignment:
...
# Child class, Homework, inheriting from Assignment.
...
# Child class, Exam, inheriting from Assignment.
